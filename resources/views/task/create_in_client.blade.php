...
<div class="container">
    <div class="row">
     <div class="col-md-10 col-md-offset-1">
       <br>
       <div class="card">
           <div class="card-heading card-info"><p><i class="fa fa-plus fa-2x" aria-hidden="true"></i> Insert a new task</p></div>
  ...
  <div class="col-md-10">
    ...
    <input type="file" id="inputFile" name="archive">
       ...
       <div class="form-group">
         ...
         {{Form::hidden('client_id',$data)}}
       </div>
       <div class="pull-right">
         <a class='btn btn-raised btn-warning' href="{{url('/folder',$data)}}">Cancel</a>
