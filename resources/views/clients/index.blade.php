...
<div class="alert alert-dismissible alert-danger">
  <button type="button" class="close" data-dismiss="alert">×</button>
  <strong><i class="fa fa-hand-paper-o" aria-hidden="true"></i> Cant do this! </strong> {{session('warning')}}
</div>
@endif
<!--panel with table-->
   ...
   <table id="fresh-table" class="table">
      <thead>
       ...
       <tbody>
           ...
           @if($data->do_date()->count() > 0)
          <tr class="danger" >
            <td><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> {{$data->business_name}}</td>
        ...
        <a class="btn btn-raised btn-danger btn-xs" href="{{url('statusd',$data->id)}}"><i class="fa fa-bell-slash-o fa-1x" aria-hidden="true"></i></a>
        @endif
